...
//
//class AddContactVC: UIViewController, UITextFieldDelegate, UITextViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate  {
//
...
//        super.viewDidLoad()
//        
//        advertCollectionRef = Firestore.firestore().collection("messageContact")
//        auth = Auth.auth()
...
//        
//        let contactName = addProductName.text!
//        //let price = addProductPrice.text!
//        let contactDesc = addProductDesc.text!
//        //var image = ""
...
//                let contact = Contact(image: downloadURL.absoluteString, contactName: contactName, location: location, telefon: telefon, contactDesc: contactDesc)
//                self.advertCollectionRef.addDocument(data: contact.toAny()) { (error) in
//                    if let error = error {
