...
class DetailVC: UIViewController {
    ...
    @IBOutlet weak var productLbl: UILabel! /// @IBOutlet weak var priceLbl: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        productLbl.text = profile.name
        productLbl.font = UIFont.boldSystemFont(ofSize: 25.0)
        productImage.image = profile.detailImage!
        locationLabel.text = profile.address!
        //productDescription.text = profile.
